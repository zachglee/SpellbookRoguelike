...
enemies = {
  ...
  "Hunter": Enemy(20, "Hunter", MultiAction([MoveAction(1), NearFarAction(AddConditionAction("armor", 1, "self"), AttackAction(8))])),
  ...
  "The Executioner": Enemy(40, "The Executioner", WindupAction(AttackAction(30), 1)),
  ...
  "Shaman of Rebirth": Enemy(12, "Shaman of Rebirth", AddConditionAction("regen", 1, "all"), entry=AddConditionAction("regen", 3, "all_enemies")),
