...
minor_health_potion = Item.make("Minor Health Potion", 1, "Heal 5", ["heal p 5"], material_cost=7)
middling_health_potion = Item.make("Middling Health Potion", 2, "Heal 4", ["heal p 4"], material_cost=10)
