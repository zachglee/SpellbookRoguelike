...
red_potion = Item.make("Red Potion", 1, "Gain 1 Red", ["red p 1"])
blue_potion = Item.make("Blue Potion", 1, "Gain 1 Blue", ["blue p 1"])
gold_potion = Item.make("Gold Potion", 1, "Gain 1 gold", ["gold p 1"])
...
ancient_key = Item.make("Ancient Key", 1, "A key to a door long forgotten.", [], rare=True)
