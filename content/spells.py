...
red_hit_big_enemy = [
  ["Passive: The first time you damage an enemy, inflict 1 burn for every 5 max hp.",
  ...
  #
  ["Passive: The first time you damage an enemy, gain 1 regen for every 5 max hp",
...
blue_block_hits = [
  ...
  "Consumer: 1 Blue: Block 5. Break: Deal thrice breaker’s attack damage back.",]
]
...
blue_3_enemies = [
  ["Passive: At the beginning of your turn if there are 3 or more enemies, stun 1 at random.",
  ...
  #
  ["Passive: At the beginning of your turn, if there are 3 or more enemies, deal 12 damage to a random enemy.",
...
blue_excess_block = [
  ...
  "Converter: 1 Blue -> 1 Gold: Lose all block, gain half that much as regen.",
...
gold_turn_page = [
  ...
  "Consumer: 1 Gold: Gain x block and x regen where x is the number of spells cast this turn."],
]
